...
##### Email settings
if ENVIRONMENT == 'development':
    # In development: emails print to the terminal — no SMTP connection needed
    ...
    EMAIL_HOST_USER = ''
    EMAIL_HOST_PASSWORD = ''
    DEFAULT_FROM_EMAIL = 'noreply@sustaura.com'
else:
...
STAFF_EMAILS = ['soash.sadat@gmail.com', 'soash2002@gmail.com']
